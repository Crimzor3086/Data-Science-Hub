  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-purple-50 text-gray-800">
      ...
      <div className="relative">
        <div className="absolute inset-0 bg-gradient-to-r from-purple-600/90 to-pink-600/90 opacity-90 z-10"></div>
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-purple-600">Why Choose Data Science Hub?</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-gradient-to-br from-blue-50 to-purple-50 border-purple-200 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-6">
                <div className="text-purple-500 text-4xl mb-4">🎓</div>
                <h3 className="text-xl font-bold mb-2 text-purple-700">Expert-Led Courses</h3>
                <p className="text-gray-600">Learn from industry professionals with years of experience in data science and AI.</p>
              </CardContent>
            </Card>
            
            <Card className="bg-gradient-to-br from-pink-50 to-purple-50 border-purple-200 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-6">
                <div className="text-pink-500 text-4xl mb-4">💼</div>
                <h3 className="text-xl font-bold mb-2 text-pink-700">Professional Services</h3>
                <p className="text-gray-600">From data analysis to AI implementation, our team delivers tailor-made solutions.</p>
              </CardContent>
            </Card>
            
            <Card className="bg-gradient-to-br from-blue-50 to-pink-50 border-purple-200 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-6">
      ...
      <div className="py-16 container mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-3xl font-bold text-purple-600">Featured Courses</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <Card key={index} className="overflow-hidden bg-white border-purple-200 shadow-lg hover:shadow-xl transition-shadow">
              <div className="h-48 overflow-hidden">
                <img src={course.image} alt={course.title} className="w-full h-full object-cover" />
              </div>
              <CardContent className="p-6">
                <div className="flex justify-between items-center mb-2">
                  <span className="bg-purple-100 text-purple-600 text-sm px-2 py-1 rounded">{course.level}</span>
                  <span className="font-bold text-pink-600">{course.price}</span>
                </div>
                <h3 className="text-xl font-bold mb-2 text-gray-800">{course.title}</h3>
                <p className="text-gray-600 mb-4">Duration: {course.duration}</p>
                <Button className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white">Learn More</Button>
              </CardContent>
            </Card>
          ))}
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              <Card key={index} className="bg-white border-purple-200 shadow-lg hover:shadow-xl transition-shadow">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 py-16 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button className="bg-white hover:bg-gray-100 text-purple-600 font-bold text-lg px-8 py-6">
      ...
      <footer className="bg-white py-12 border-t border-gray-200">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4 text-purple-600">Data Science Hub</h3>
